...
public class IceArmorItem extends ArmorItem implements AscensionUtil {
    ...
    public void inventoryTick(@NotNull ItemStack stack, Level level, @NotNull Entity entity, int slotId, boolean isSelected) {
        if (!level.isClientSide() && entity instanceof Player player && hasArmorSet(player, IceArmorItem.class)) {
