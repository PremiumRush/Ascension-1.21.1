...
public class DarknessParticle extends TextureSheetParticle {
    public DarknessParticle(ClientLevel p_105856_, double p_105857_, double p_105858_, double p_105859_, double p_105860_, double p_105861_, double p_105862_) {
        super(p_105856_, p_105857_, p_105858_, p_105859_);
        this.scale(10.0F);
        this.setSize(0.4F, 0.4F);
        this.lifetime = this.random.nextInt(20) + 600;

        this.alpha = 0.95F;
        this.rCol = 0.1315625F;
        this.gCol = 0.1315625F;
        this.bCol = 0.1415625F;
        this.gravity = 0;
        this.xd = p_105860_;
        this.yd = p_105861_;
        this.zd = p_105862_;
    ...
    public static class CosyProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType p_105889_, ClientLevel p_105890_, double p_105891_, double p_105892_, double p_105893_, double p_105894_, double p_105895_, double p_105896_) {
            DarknessParticle $$8 = new DarknessParticle(p_105890_, p_105891_, p_105892_, p_105893_, p_105894_, p_105895_, p_105896_);
            $$8.setAlpha(0.95F);
