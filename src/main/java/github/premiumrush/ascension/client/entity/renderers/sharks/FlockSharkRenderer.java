...
public class FlockSharkRenderer extends MobRenderer<SharkEntity, SharkModel<SharkEntity>> {
    public FlockSharkRenderer(EntityRendererProvider.Context context) {
    ...
    public ResourceLocation getTextureLocation(SharkEntity sharkEntity) {
        return ResourceLocation.fromNamespaceAndPath(Ascension.MODID, "textures/entity/flock_shark.png");
    }
