...
public class TamedGhostRenderer extends MobRenderer<TamedGhostEntity, GhostModel<TamedGhostEntity>> {
    public TamedGhostRenderer(EntityRendererProvider.Context context) {
        super(context, new GhostModel<>(context.bakeLayer(EntityModelLayers.GHOST_LAYER)), 0.4f);
    }

    @Override
    public ResourceLocation getTextureLocation(TamedGhostEntity ghostEntity) {
        return ResourceLocation.fromNamespaceAndPath(Ascension.MODID, "textures/entity/ghost_tame.png");
    }
}
