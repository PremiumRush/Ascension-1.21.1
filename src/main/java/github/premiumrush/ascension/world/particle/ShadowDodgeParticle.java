package github.premiumrush.ascension.world.particle;
...
public class ShadowDodgeParticle extends TextureSheetParticle {
    public ShadowDodgeParticle(ClientLevel p_105856_, double p_105857_, double p_105858_, double p_105859_, double p_105860_, double p_105861_, double p_105862_, boolean p_105863_) {
    ...
    public static class CosyProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType p_105889_, ClientLevel p_105890_, double p_105891_, double p_105892_, double p_105893_, double p_105894_, double p_105895_, double p_105896_) {
            ShadowDodgeParticle $$8 = new ShadowDodgeParticle(p_105890_, p_105891_, p_105892_, p_105893_, p_105894_, p_105895_, p_105896_, false);
            $$8.setAlpha(0.9F);
