...
public class VexalSwordInfusedItem extends SwordItem {
    ...
    public boolean hurtEnemy(@NotNull ItemStack pStack, @NotNull LivingEntity pTarget, @NotNull LivingEntity pAttacker) {
        ...
        {
            pTarget.hurt(pTarget.damageSources().generic(),10.0F);
            pTarget.addEffect(new MobEffectInstance(MobEffects.WEAKNESS,120,1));
        }
